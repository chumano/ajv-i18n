...
module.exports = {
  ...
  additionalItems: {
    ...
    vi: "{{#def.n}}phải KHÔNG nhiều hơn {{=n}}{{#def.mPlural}}",
  ...
  additionalProperties: {
    ...
    vi: "KHÔNG được có thuộc tính khác",
    zh: "不允许有额外的属性",
    "zh-TW": "不可以有額外的屬性",
  },
  anyOf: {
    ...
    vi: 'phải phù hợp với mô tả "anyOf"',
  ...
  dependencies: {
    ...
    vi: "{{#def.n}}phải có thuộc tính{{#def.propPlural}} {{=e.params.deps}} khi có thuộc tính {{=e.params.property}}",
  ...
  enum: {
    ...
    vi: "phải là một trong các giá trị được cho phép",
    zh: "应当是预设定的枚举值之一",
    "zh-TW": "應該要在預設的值之中",
  },
  format: {
    ...
    vi: 'phải thỏa mãn định dạng "{{=e.params.format}}"',
  ...
  maxItems: {
    ...
    vi: "{{#def.n}}KHÔNG được có hơn {{=n}} phần tử{{#def.mPlural}}",
    zh: "{{#def.n}}不应多于 {{=n}} 个项",
  ...
  minItems: {
    ...
    vi: "{{#def.n}}KHÔNG được có ít hơn {{=n}} phần tử{{#def.mPlural}}",
    zh: "{{#def.n}}不应少于 {{=n}} 个项",
  ...
  maxLength: {
    ...
    vi: "{{#def.n}}KHÔNG nhiều hơn {{=n}} kí tự{{#def.mPlural}}",
    zh: "{{#def.n}}不应多于 {{=n}} 个字符",
  ...
  minLength: {
    ...
    vi: "{{#def.n}}KHÔNG được ít hơn {{=n}} kí tự{{#def.mPlural}}",
    zh: "{{#def.n}}不应少于 {{=n}} 个字符",
  ...
  maxProperties: {
    ...
    vi: "{{#def.n}}KHÔNG được có hơn {{=n}} thuộc tính{{#def.propPlural}}",
  ...
  minProperties: {
    ...
    vi: "{{#def.n}}KHÔNG được ít hơn {{=n}} thuộc tính{{#def.propPlural}}",
  ...
  multipleOf: {
    ...
    vi: "phải là bội số của {{=e.params.multipleOf}}",
  ...
  not: {
    ...
    vi: 'KHÔNG được có theo mô tả trong "not"',
    zh: '不应当匹配 "not" schema',
  ...
  oneOf: {
    ...
    vi: 'phải thỏa mãi một mô tả trong "oneOf"',
  ...
  pattern: {
    ...
    vi: 'phải thỏa mãn mẫu "{{=e.params.pattern}}"',
  ...
  required: {
    ...
    vi: "phải có thuộc tính bắt buộc {{=e.params.missingProperty}}",
  ...
  unevaluatedProperties: {
    ...
    vi: "KHÔNG có thuộc tính để đánh giá",
    zh: "不允许存在未求值的属性",
    "zh-TW": "不應該有未驗證的屬性",
  },
  unevaluatedItems: {
  ...
  uniqueItems: {
    ...
    vi: "KHÔNG được có phần tự trùng (các phần tử ## {{=e.params.j}} và {{=e.params.i}} thì giống nhau)",
  ...
  propertyNames: {
    ...
    vi: "tên thuộc tính không hợp lệ",
    zh: "属性名 无效",
    "zh-TW": "属性名 無效",
  },
  patternRequired: {
    ...
    vi: 'phải có thược tính phù hợp với mẫu "{{=e.params.missingPattern}}"',
  ...
  contains: {
    ...
    vi: "phải chứa một phần tử hợp lệ",
    zh: "应当包含一个有效项",
    "zh-TW": "應該包含一個有效元素",
  },
  formatMaximum: {
  ...
  if: {
    ...
    vi: 'phải thỏa mãn mô tả "{{=e.params.failingKeyword}}"',
  ...
  discriminator: {
    ...
    tag: {
      ...
      vi: 'nhãn "{{=e.params.tag}}" phải là chuỗi kí tự',
    ...
    mapping: {
      ...
      vi: 'giá trị của nhãn "{{=e.params.tag}}" phải thuộc oneOf',
